...
$(function() {
  ...
  function set_settings() {
    ...
    settings.condition_1_likes = [120000]; 
    settings.condition_1_Disslikes = [20000]; 
    ...
    settings.condition_2_likes = [10000, 13000,35000,80000,11000,15000];  
    //settings.condition_2_Disslikes = [1000, 15000,150000]; 
   ...
   // settings.condition_3_likes = [10000, 11000,15000,35000,80000,100000,110000,150000,20000]; 
    settings.condition_3_Disslikes = [10000, 13000,35000,80000,11000,15000];
	...
	settings.condition_3_adjusted_likes = [12000, 14000]; //1	
	
	//Other Disslikes
	settings.condition_1_adjusted_Disslikes = [12000, 14000,15000,35000,80000,100000,110000,150000,20000]; // 9
	settings.condition_2_adjusted_Disslikes = [12000, 14000,15000,35000,80000]; // 5
	settings.condition_3_adjusted_Disslikes = [12000, 14000]; //1	
    ...
    // Usernames by which the participant will receive "Disslikes"
	// If group member names are changed, these should be changed accordingly.

      settings.Disslikes_by = ['John','AncaD','Sarah','Arjen','Jane','George','Dan','Heather','Ky']; 
    }
  // -------------------
  ...
  function init_task() {
		  ...
		  "posts" : [
			{
			  ...
			  "Disslikes": window.settings.condition_likes,
			  "usernames": window.settings.likes_by,
			 "usernamesDiss": window.settings.Disslikes_by
			}
		  ]
		};
    ...
    // When user receives Dislikes
	  $('.usersDisslikes').each(function() {
  		...
  		var times = $(this).data('Disslikes').split(",");
    ...
    // When others receive likes
	  $('.otherslikes').each(function() {
	      ...
	      // When others receive Disslikes
	  $('.othersDisslikes').each(function() {
  		var that = $(this);
  		var times = $(this).data('Dissikes').split(",");
  ...
  function adjust_to_condition() {
	...
	switch(condition) {
		case 1:
			...
			window.settings.condition_Disslikes = settings.condition_1_Disslikes;
			window.others.posts[1].likes = settings.condition_1_adjusted_likes;
			window.others.posts[1].Disslikes = settings.condition_1_adjusted_Disslikes;
			break;
		case 2:
			window.settings.condition_likes = settings.condition_2_likes;
			window.settings.condition_Disslikes = settings.condition_2_Disslikes;
			window.others.posts[1].likes = settings.condition_2_adjusted_likes;
			window.others.posts[1].Disslikes = settings.condition_2_adjusted_Disslikes;
			break;
		case 3:
			window.settings.condition_likes = settings.condition_3_likes;
			window.settings.condition_Disslikes = settings.condition_3_Disslikes;
			window.others.posts[1].likes = settings.condition_3_adjusted_likes;
			window.others.posts[1].Disslikes = settings.condition_3_adjusted_Disslikes;
			break;
	}	
