...
$(function() {
  ...
  function set_settings() {
    ...
    settings.condition_1_likes = [12000]; 
    settings.condition_1_Disslikes = [9999999]; 
   ...
   // settings.condition_3_likes = [10000, 11000,15000,35000,80000,100000,110000,150000,20000]; 
    settings.condition_3_Disslikes = [10000, 11000,15000,35000,80000,100000,110000,150000,20000]; 
	...
	settings.condition_3_adjusted_Disslikes = [12000,  9999999]; //1	
